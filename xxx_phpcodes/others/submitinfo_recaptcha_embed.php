...
$Message = "<html><head><title>My Feedback to Angelia </title></head><body>
  <p>The following is my submittal and proposal to the site of Angelia. </p>". $Body. "</body></html>";
...
//////////////////////////////////////////////////////////////////////////////////////
			...
			$success = mail($To, $Submittal, $Message, $Headers);
			//echo $success;
...
echo "<HTML><HEAD><TITLE> Your submittal is sent successfully ! </TITLE></HEAD>";
echo '<META content="text/html; charset=utf-8" http-equiv=Content-Type>';

echo "<table width=500 border='2'  align='center' cellspacing='0' cellpadding='1'> <tr><td width='500' bgcolor='#D8D8EB'> <H2 align=center>  Thank you !  <b> <font color='#CC3300'>".$Title."\r\n".$Name." </font></b>, Your submittal is sent out successfully! We will anwer you within the next 24 hours. Meanwhile please check your email boxes, also the junk boxes, for new emails, in order to get your timely replies.  </H2></td></tr> ";
